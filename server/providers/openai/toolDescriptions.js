export const ACTION_DESCRIPTIONS = {
  fly_to_location: {
    description:
      "Fly the God's Earth View camera to a known city, geocoded country/region/city/landmark, or explicit WGS84 coordinate. Countries/cities frame the whole place; landmarks/buildings use close framing.",
    $position: 1,
    parameters: {
      properties: {
        locationId: {
  ...
  set_visual_style: {
    description: "Set the active God's Earth View visual filter/style.",
    $position: 1,
  },
  get_entity_context: {
    description:
